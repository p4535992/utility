...
import com.github.p4535992.util.log.*;
...
public class SystemLog extends OutputStream{
   ...
   /* private static java.lang.reflect.Type t;
    ...
    protected static Logger logUtil;
...
*/
    ...
    public static void setIsERROR(boolean isERROR) {
        SystemLog.isERROR = isERROR;}

    public static boolean isLogOff() {return isLogOff;}

    public static void setIsLogOff(boolean isLogOff) {
        com.github.p4535992.util.log.SystemLog.isLogOff = isLogOff;}
    ...
    public static void setIsDEBUG(boolean isDEBUG) {
        com.github.p4535992.util.log.SystemLog.isDEBUG = isDEBUG; }

    public static boolean isLog4j() {return isLog4j;}

    public static void setIsLog4j(boolean isLog4j) {
        com.github.p4535992.util.log.SystemLog.isLog4j = isLog4j;}

    public static boolean isSlf4j() {return isSlf4j;}

    public static void setIsSlf4j(boolean isSlf4j) {
        com.github.p4535992.util.log.SystemLog.isSlf4j = isSlf4j;}

    public static boolean isInline() { return isInline; }

    public static void setIsInline(boolean isInline) { com.github.p4535992.util.log.SystemLog.isInline = isInline; }

    private static com.github.p4535992.util.log.SystemLog instance = null;

    public static com.github.p4535992.util.log.SystemLog start(){
        if(instance == null) {
            prepareLogFile(null, null, null);
            instance = new com.github.p4535992.util.log.SystemLog();
        }
        return instance;
    }

    public static com.github.p4535992.util.log.SystemLog start(File file){
        if(instance == null){
            prepareLogFile(
    ...
    public static com.github.p4535992.util.log.SystemLog start(String LOGNAME, String SUFFIX){
        if(instance == null){
    ...
    public static com.github.p4535992.util.log.SystemLog startWithLog4J(File fileXML){
        isLog4j = true;
    ...
    public static com.github.p4535992.util.log.SystemLog startWithLog4J(File fileOutput,File fileXML){
        isLog4j = true;
        isPRINT = true;
        if(instance == null){
    ...
    private static void prepareLogFile(String LOGNAME, String SUFFIX,String PATHFILE){
        ...
        if(LOGNAME!=null) {
            ...
            if (PATHFILE == null) {
                isPRINT = true;
                com.github.p4535992.util.log.SystemLog.logfile =
                        new File(System.getProperty("user.dir") + File.separator
                                + LOGNAME + "_" + logTimestampFile + "." + SUFFIX);
            } else {
                isPRINT = true;
                com.github.p4535992.util.log.SystemLog.logfile = new File(
    ...
    protected SystemLog(){
        try {
            if(isLog4j){ /*do nothing*/}
                ...
                if (logfile == null) com.github.p4535992.util.log.PrintLog.start();
                else com.github.p4535992.util.log.PrintLog.start(logfile);
            }
        } catch (Exception ex) {
